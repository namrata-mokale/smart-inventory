    ...
    with app.app_context():
        try:
            ...
            migration_tasks = [
                ...
                ('supplier_bills', 'gst_amount', 'FLOAT DEFAULT 0.0'),
                ('supplier_bills', 'total', 'FLOAT DEFAULT 0.0'),
                ('supplier_bills', 'grand_total', 'FLOAT DEFAULT 0.0'),
                ('supplier_quotes', 'expiry_date', 'DATE'),
                ('supplier_quotes', 'gst_rate', 'FLOAT DEFAULT 0.18'),
                ('supplier_quotes', 'gst_amount', 'FLOAT DEFAULT 0.0'),
                ('supplier_quotes', 'total', 'FLOAT DEFAULT 0.0'),
                ('supplier_quotes', 'grand_total', 'FLOAT DEFAULT 0.0'),
                ('transactions', 'gst_rate', 'FLOAT DEFAULT 0.18'),
